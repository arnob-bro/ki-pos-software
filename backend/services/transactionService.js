...
class TransactionService {
	...
	async addTransaction(transaction, currentUser) {
		console.log(
			"DEBUG: TransactionService.addTransaction called with:",
      ...
      `);
			...
			console.log(
				"DEBUG: Transaction record inserted, changes:",
				transactionResult.changes
			);
      ...
      `);
			...
			for (const item of transaction.items) {
				...
				console.log(
					"DEBUG: Stock update for product",
					item.product_id,
					"changes:",
					stockResult.changes
				);
		...
		try {
			...
			console.log(
				"DEBUG: Transaction completed successfully with ID:",
				result.id
			);
