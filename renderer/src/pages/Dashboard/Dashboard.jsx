							...
							{role === 2 && (
								<>
									<div className='dash-card'>
										...
										<div className='card'>
											<h4>
												{t("Revenue Per Employee", "Umsatz pro Mitarbeiter")}
											</h4>
											<h2>$877.00</h2>
										...
										>
											...
											<h2>
												{lowStockItems.length} {t("items", "Artikel")}
											</h2>
									...
									<div className='charts-section'>
										<div className='charts-box'>
											<h3>
												{t("Daily Sales Overview", "Tägliche Umsatzübersicht")}
											</h3>
							...
							{role === 1 && (
								<>
									...
									<div className='dash-card'>
										...
										<div className='card'>
											<h4>
												{t("Total Transactions", "Transaktionen insgesamt")}
											</h4>
									...
									<div className='chart-row'>
										<div className='chart-box z-reports'>
											...
											<ul className='z-report-list'>
												<li>
													<strong>{t("June 30, 2025", "30. Juni 2025")}</strong>{" "}
													– {t("Total Sales", "Gesamtumsatz")}: $4,200 –{" "}
													{t("Transactions", "Transaktionen")}: 86
												</li>
												<li>
													<strong>{t("June 29, 2025", "29. Juni 2025")}</strong>{" "}
													– {t("Total Sales", "Gesamtumsatz")}: $3,950 –{" "}
													{t("Transactions", "Transaktionen")}: 80
												</li>
												<li>
													<strong>{t("June 28, 2025", "28. Juni 2025")}</strong>{" "}
													– {t("Total Sales", "Gesamtumsatz")}: $4,100 –{" "}
													{t("Transactions", "Transaktionen")}: 84
												</li>
											</ul>
										</div>
										...
										<div className='audit-trail'>
											...
											<div className='audit-wrapper'>
												...
												<div className='pagination-controls'>
													...
													<span>
														{t("Page", "Seite")} {currentPage} {t("of", "von")}{" "}
														{totalPages}
													</span>
													<button
														onClick={() =>
