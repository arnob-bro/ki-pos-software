...
const EmployeeManagement = () => {
	...
	const handleEdit = async (employee) => {
		try {
			...
			const employeePermissions = await window.posAPI.getEmployeePermissions(
				employee.id
			);
	...
	const handleSubmit = async (e) => {
		...
		try {
			...
			if (employeeId) {
				const currentAssignmentsRes = await window.posAPI.listShiftAssignments({
					userId: employeeId,
				});
			...
			<div className='employee-management'>
				...
				<div className='employee-stats'>
					...
					<div className='stat-cards'>
						<h4>Managers</h4>
						<span>
							{employees.filter((e) => e.role_name === "manager").length}
						</span>
					</div>
					<div className='stat-cards'>
												...
												<div className='role-permissions'>
													{role.permissions ? (
														...
														<span className='no-permissions'>
															{t("No permissions", "Keine Berechtigungen")}
														</span>
													)}
												</div>
											</td>
				...
				{isAdmin && (
					<div className='shift-management-section'>
						...
						{shiftLoading ? (
							<div>{t("Loading shifts...", "Schichten werden geladen...")}</div>
						) : (
									...
									<tbody>
										{shifts.map((shift) => (
											<tr key={shift.id}>
												...
												<td>
													<button onClick={() => openShiftModal(shift)}>
														{t("Edit", "Bearbeiten")}
													</button>
												</td>
											</tr>
							...
							<div className='modal-overlay'>
								<div className='modal-content'>
									<div className='modal-header'>
										<h3>
											{editingShift
												? t("Edit Shift", "Schicht bearbeiten")
												: t("Add Shift", "Schicht hinzufügen")}
										</h3>
										<button className='close-btn' onClick={closeShiftModal}>
											×
										</button>
									</div>
									<form onSubmit={handleShiftSubmit} className='shift-form'>
										...
										<div className='form-actions'>
											...
											>
												{editingShift
													? t("Update Shift", "Schicht aktualisieren")
													: t("Add Shift", "Schicht hinzufügen")}
											</button>
											<button
												type='button'
					...
					<div className='modal-overlay'>
						<div className='modal-content'>
							<div className='modal-header'>
								...
								<button className='close-btn' onClick={closeShiftAssignModal}>
									×
								</button>
							</div>
									...
									{shifts.map((shift) => (
										...
										>
											<input
												...
												onChange={(e) =>
													e.target.checked
														? handleAssignShiftToEmployee(shift.id)
														: handleUnassignShiftFromEmployee(shift.id)
												}
				...
				{pagination.totalPages > 1 && (
					<div className='pagination'>
						...
						<span className='pagination-info'>
							{t("Page %s of %s", "Seite %s von %s")} {pagination.page}{" "}
							{t("of", "von")} {pagination.totalPages}
						</span>
						<button
							onClick={() => handlePageChange(pagination.page + 1)}
					...
					<div className='modal-overlay'>
						<div className='modal-content'>
							<div className='modal-header'>
								<h3>
									{editing
										? t("Edit Employee", "Mitarbeiter bearbeiten")
										: t("Add New Employee", "Neuen Mitarbeiter hinzufügen")}
								</h3>
							...
							<form onSubmit={handleSubmit} className='employee-form'>
								<div className='form-section'>
									<h4>
										{t("Basic Information", "Grundlegende Informationen")}
									</h4>
									...
									<div className='form-row'>
										...
										>
											<option value=''>
												{t("Select Shift", "Schicht auswählen")}
											</option>
											{shifts.map((shift) => {
								...
								<div className='form-actions'>
									<button type='submit' className='submit-btn'>
										{editing
											? t("Update Employee", "Mitarbeiter aktualisieren")
											: t("Add Employee", "Mitarbeiter hinzufügen")}
									</button>
									<button
										type='button'
						...
						<div className='modal-content'>
							<div className='modal-header'>
								<h3>
									{editingRole
										...
										: t("Add New Role", "Neue Rolle hinzufügen")}
								</h3>
							...
							<form onSubmit={handleRoleSubmit} className='role-form'>
								...
								<div className='form-actions'>
									<button type='submit' className='submit-btn'>
										{editingRole
											? t("Update Role", "Rolle aktualisieren")
