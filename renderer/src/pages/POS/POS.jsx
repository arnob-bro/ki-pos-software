                  ...
                  {queue.map((q, idx) => (
                    ...
                    >
                      ...
                      <button
                        ...
                        onClick={(e) => handleRemoveQueueItem(idx, e)}
                      >
                        ×
                      </button>
                      <div
        ...
        <div className="content">
          ...
          <div className="content-middle-area">
              ...
              <div className="input-fields">
                <div className="input-field-row">
                  <div className="input-group">
                    <label htmlFor="customer-mobile">Customer mobile no.</label>
                    <input
                      id="customer-mobile"
                  ...
                  <div className="input-group">
                    <label htmlFor="membership">Membership Code</label>
                    <input
                      id="customer-mobile"
                      className="input-element"
            ...
            <div className="product-grid">
              {loading && (
                <div>
                  {t("Loading products...", "Produkte werden geladen...")}
                </div>
              )}
              ...
              <div className="receipt-style">
                ...
                >
                  {Object.values(cart).length === 0 && (
                    ...
                    >
                      {t("No items in cart", "Keine Artikel im Warenkorb")}
                    </div>
                  )}
            ...
            <div className="payment-section">
              <div className="add-to-queue-pay-btns">
                ...
                <div className="transaction-amount-section">
                  ...
                  <div>
                    <label htmlFor="paid-amount" className="paid-amount-label">
                      Paid Amount :
                    </label>
                    <input
                      id="paid-amount"
                  ...
                  <div>
                    ...
                    <span>${(paidAmount - total).toFixed(2) || 0}</span>
                  </div>
                </div>
