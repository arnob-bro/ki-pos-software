...
const ProductManagement = () => {
	...
	const handleChange = (e) => {
		...
		const processedValue =
			name === "category_id" ? (value ? value : "") : value;
	...
	const handleSubmit = async (e) => {
		...
		try {
			...
			alert(
				t("Error saving product: ", "Fehler beim Speichern des Produkts: ") +
					error.message
			);
		}
	};
	...
	const handleDelete = async (id) => {
		if (
			...
			try {
				...
				alert(
					t("Error deleting product: ", "Fehler beim Löschen des Produkts: ") +
						error.message
				);
			}
		}
			...
			try {
				...
				alert(
					t(
						...
						"Fehler beim Importieren der Produkte: "
					) + error.message
				);
			}
		};
			...
			<div className='product-management'>
				...
				<form onSubmit={handleSubmit} className='product-form'>
					...
					<div className='form-group'>
						...
						>
							<option value=''>
								{t("Select Category", "Kategorie wählen")}
							</option>
							{categories.map((cat) => (
